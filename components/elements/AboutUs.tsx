      ...
      <section className="absolute -translate-y-full">
        <div className="w-[50vw] h-lvh absolute right-0 top-0 bg-black flex items-center pr-pcx pl-[22px]">
          <p>
            ...
            благополуччя. У нашому застосунку ви знайдете зручну карту, щоб
            легко знаходити найближчі зали, оглянете профілі наших тренерів, щоб
            обрати того, хто найбільше відповідає вашим потребам, та
            ознайомитесь з широким спектром послуг, які ми пропонуємо. Наша мета
            - надихати вас на досягнення нових висот у фітнесі та допомагати
            кожному клієнту зробити крок до кращого самопочуття та
            здоров&apos;я.
          </p>
        </div>
      </section>
