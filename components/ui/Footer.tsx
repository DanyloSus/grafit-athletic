...
const Footer = () => {
  return (
    <footer className="border-t-[1px] border-t-grey w-lvw sm:h-[450px] lg:h-[406px] flex justify-between items-center px-mx md:px-tx lg:px-pcx bg-black z-50 relative rules">
      <div className="flex flex-col sm:gap-[47px] lg:gap-[35px]">
      ...
      <div className="flex flex-col sm:gap-[35px]  ">
